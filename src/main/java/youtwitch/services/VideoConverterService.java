...
public abstract class VideoConverterService {
    ...
    private static final VideoSize VIDEO_SIZE = new VideoSize(Const.WIDTH_FOR_CAPTURE, Const.HEIGHT_FOR_CAPTURE);
    ...
    private static final String FILE_PATH = "container\\";
    private static final String RESULT_PATH = "src\\main\\resources\\static\\";


    public static void convertVideo() throws IOException {

        File source = new File(FILE_PATH + "stream_record.avi");
        File target = new File(RESULT_PATH + "stream_record.mp4");
